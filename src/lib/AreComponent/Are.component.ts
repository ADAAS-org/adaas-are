...
export class Are extends A_Component {
    ...
    static Signal(...args: any[]): any {
        // Bare usage: `@Are.Signal myMethod()` — invoked by the decorator
        // runtime as (target, propertyKey, descriptor).
        ...
        // Typed usage: `@Are.Signal(MySignal) myMethod()` — first invocation
        // receives the signal constructor and must return a method decorator.
        const ctor = args[0] as A_TYPES__Ctor<A_Signal> & { entity?: string; name: string };
