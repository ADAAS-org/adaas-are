...
exports.AreInstruction = class AreInstruction extends aConcept.A_Entity {
   ...
   */
  get type() {
    return aConcept.A_CommonHelper.getComponentName(this.constructor);
  }
  get owner() {
  ...
  fromNew(newEntity) {
    this.aseid = this.generateASEID({
      ...
      entity: aConcept.A_FormatterHelper.toKebabCase(newEntity.name)
      // id: id,
    });
   ...
   */
  fromJSON(serialized) {
    this.aseid = new aConcept.ASEID(serialized.aseid);
   ...
   */
  apply(scope) {
    this.call(AreInstruction_constants.AreInstructionFeatures.Apply, scope);
  }
  /**
   ...
   */
  update(scope) {
    this.call(AreInstruction_constants.AreInstructionFeatures.Update, scope);
  }
  /**
   ...
   */
  revert(scope) {
    this.call(AreInstruction_constants.AreInstructionFeatures.Revert, scope);
  }
  /**
...
//# sourceMappingURL=AreInstruction.entity.js.map
//# sourceMappingURL=AreInstruction.entity.js.map