...
exports.AreSyntax = class AreSyntax extends aConcept.A_Component {
  get config() {
    return aConcept.A_Context.scope(this).resolveFlat(AreSyntax_context.AreSyntaxContext);
  }
  isRootNode(node) {
  ...
  extractRoots(template) {
    ...
    while ((match = rootTagRegex.exec(template)) !== null) {
      ...
      if (endIndex === -1) {
        throw new aConcept.A_Error(`Missing closing tag for <${rootTag}> starting at index ${startIndex}`);
      }
...
//# sourceMappingURL=AreSyntax.component.js.map
//# sourceMappingURL=AreSyntax.component.js.map