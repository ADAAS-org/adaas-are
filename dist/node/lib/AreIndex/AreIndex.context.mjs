...
import { A_Fragment, ASEID, A_Context } from '@adaas/a-concept';

class AreIndex extends A_Fragment {
  constructor(aseid) {
    super({
  ...
  get parent() {
    return A_Context.scope(this).parent?.resolve(AreIndex);
  }
  get size() {
...
export { AreIndex };
//# sourceMappingURL=AreIndex.context.mjs.map
//# sourceMappingURL=AreIndex.context.mjs.map