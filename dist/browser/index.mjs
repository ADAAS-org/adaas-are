import { A_Meta, A_Feature, A_Inject, A_Caller, A_Scope, A_TYPES__EntityFeatures, A_Dependency, A_ComponentMeta, A_Error, A_Component, A_Fragment, A_Context, A_Entity, A_FormatterHelper, A_TypeGuards, A_CommonHelper } from '@adaas/a-concept';
...
import { AreNodeFeatures as AreNodeFeatures$1 } from '@adaas/are/node/AreNode.constants';
import { A_Logger } from '@adaas/a-utils/a-logger';
import { AreAttributeFeatures as AreAttributeFeatures$1 } from '@adaas/are/attribute/AreAttribute.constants';
import { AreDeclaration } from '@adaas/are/instruction/types/AreDeclaration.instruction';
import { AreInstructionFeatures, AreInstructionDefaultNames as AreInstructionDefaultNames$1 } from '@adaas/are/instruction/AreInstruction.constants';
...
import { AreInstructionError as AreInstructionError$1 } from '@adaas/are/instruction/AreInstruction.error';
import { AreFeatures as AreFeatures$1 } from '@adaas/are/component/Are.constants';
...
import { AreInit as AreInit$1 } from '@adaas/are/signals/entities/AreInit.signal';
...
var AreNode = class extends A_Entity {
  ...
  async load() {
    ...
    try {
      const context = this.scope.resolve(AreContext$1);
...
var AreAttribute2 = class extends A_Entity {
  /**
...
], AreAttribute2.prototype, "compile", 1);
AreAttribute2 = __decorateClass([
  A_Frame.Component({
    namespace: "A-ARE",
    name: "AreAttribute",
...
var AreTokenizer = class extends A_Component {
   ...
   */
  get config() {
    const syntax = A_Context.scope(this).resolve(AreSyntax$1);
...
__decorateClass([
  ...
  __decorateParam(0, A_Inject(AreContext$1))
], AreTokenizer.prototype, "instantiate", 1);
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onTokenize,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
  __decorateParam(1, A_Inject(AreContext$1)),
...
var AreCompiler = class extends A_Component {
  static Compile(param1) {
    return (target, propertyKey, descriptor) => {
      return A_Feature.Extend({
        name: param1.prototype instanceof AreNode$1 ? AreNodeFeatures$1.onCompile : AreAttributeFeatures$1.Compile,
        scope: [param1],
        override: ["compile"]
      })(target, propertyKey, descriptor);
    };
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onCompile,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onTransform,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onInterpret,
    scope: [AreNode$1]
  }),
...
var AreStore2 = class extends A_ExecutionContext {
  constructor(aseid) {
  ...
  get parent() {
    return this.owner.parent?.scope.resolve(AreStore2);
  }
  get context() {
    return A_Context.scope(this).resolve(AreContext$1);
  }
  get watchers() {
...
var AreScene5 = class extends A_Fragment {
  constructor(id) {
...
var AreInstruction3 = class extends A_Entity {
  /**
   ...
   */
  apply(scope) {
    this.call(AreInstructionFeatures2.Apply, scope);
  }
  /**
   ...
   */
  update(scope) {
    this.call(AreInstructionFeatures2.Update, scope);
  }
  /**
   ...
   */
  revert(scope) {
    this.call(AreInstructionFeatures2.Revert, scope);
  }
};
AreInstruction3 = __decorateClass([
  A_Frame.Entity({
    namespace: "A-ARE",
    name: "AreInstruction",
...
var AreDeclaration3 = class extends AreInstruction {
  constructor(param1, param2, param3) {
    if (typeof param1 === "object" && "aseid" in param1)
      super(param1);
    else
      super({
        name: param1 || AreInstructionDefaultNames$1.Default,
        parent: param2 instanceof AreDeclaration3 ? param2 : void 0,
        group: param2 instanceof AreDeclaration3 ? param2.group : void 0,
        payload: param2 instanceof AreDeclaration3 ? param3 || {} : param2 || {}
        // id: [param1, A_IdentityHelper.generateTimeId(), param2 instanceof AreDeclaration ? (param3 || {}) as T : (param2 || {}) as T]
      });
  }
};
AreDeclaration3 = __decorateClass([
  A_Frame.Entity({
    namespace: "A-ARE",
    name: "AreDeclaration",
...
var AreMutation2 = class extends AreInstruction {
  get parent() {
    return this._parent;
  }
  get group() {
  ...
  constructor(param1, param2, param3) {
    if (typeof param1 === "object" && "aseid" in param1)
      ...
      super({
        name: param1 || AreInstructionDefaultNames$1.Mutation,
        group: param2,
        parent: param2,
        payload: param3
  ...
  fromNew(newEntity) {
    if (!newEntity.parent)
      throw new AreInstructionError$1({
...
var AreLifecycle = class extends A_Component {
  static Init(param1) {
    return (target, propertyKey, descriptor) => {
      return A_Feature.Extend({
        name: param1.prototype instanceof AreNode$1 ? AreNodeFeatures$1.onInit : AreAttributeFeatures$1.Init,
        scope: [param1],
        override: ["init"]
      })(target, propertyKey, descriptor);
    };
  ...
  beforeInit(node, scope, scene, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onBeforeInit, node.scope);
  }
  ...
  afterInit(node, scope, scene, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onAfterInit, node.scope);
  }
  beforeMount(node, scope, scene, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onBeforeMount, node.scope);
  }
  ...
  afterMount(node, scope, scene, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onAfterMount, node.scope);
  }
  beforeUpdate(node, scope, scene, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onBeforeUpdate, node.scope);
  }
  ...
  afterUpdate(node, scope, scene, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onAfterUpdate, node.scope);
  }
  beforeUnmount(node, scope, scene, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onBeforeUnmount, node.scope);
  }
  ...
  afterUnmount(node, scope, scene, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onAfterUnmount, node.scope);
  }
  beforeDestroy(node, scope, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onBeforeDestroy, node.scope);
  }
  ...
  afterDestroy(node, scope, feature, ...args) {
    ...
    if (node.component)
      feature.chain(node.component, AreFeatures$1.onAfterDestroy, node.scope);
  }
};
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onBeforeInit,
    before: /.*/,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onInit,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
  __decorateParam(1, A_Inject(A_Scope)),
  __decorateParam(2, A_Inject(AreContext$1)),
  __decorateParam(3, A_Inject(A_Logger))
], AreLifecycle.prototype, "init", 1);
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onAfterInit,
    after: /.*/,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onBeforeMount,
    before: /.*/,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onMount,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
  __decorateParam(1, A_Inject(AreScene)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onAfterMount,
    after: /.*/,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onUpdate,
    before: /.*/,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onBeforeUnmount,
    before: /.*/,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onUnmount,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
  __decorateParam(1, A_Inject(AreScene))
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onAfterUnmount,
    after: /.*/,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onBeforeDestroy,
    before: /.*/,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onAfterDestroy,
    after: /.*/,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
...
__decorateClass([
  ...
  __decorateParam(2, A_Inject(A_Feature)),
  __decorateParam(3, A_Inject(A_Logger)),
  __decorateParam(4, A_Inject(AreContext$1))
...
var AreSignalsContext = class extends A_Fragment {
  ...
  signalsMeta() {
    const signalsMeta = A_Context.meta(AreSignals2);
    if (!signalsMeta) {
...
var AreSignals2 = class extends A_Component {
    ...
    try {
      for (const root of context.subscribers) {
        const callScope = new A_Scope({
          fragments: [new AreEvent$1(
            AreFeatures$1.onSignal,
            {
              vector
            }
          )]
...
], AreSignals2.prototype, "handleSignalVector", 1);
__decorateClass([
  A_Feature.Extend({
    name: AreNodeFeatures$1.onEmit,
    scope: [AreNode$1]
  }),
  __decorateParam(0, A_Inject(A_Caller)),
  __decorateParam(1, A_Inject(A_Scope)),
  __decorateParam(2, A_Inject(AreEvent$1)),
  __decorateParam(3, A_Inject(A_Feature)),
  __decorateParam(4, A_Inject(A_Logger))
], AreSignals2.prototype, "propagateEvent", 1);
AreSignals2 = __decorateClass([
  A_Frame.Component({
    namespace: "A-ARE",
    name: "AreSignals",
...
var AreInit = class _AreInit extends AreSignal$1 {
  static default() {
    return new _AreInit({ data: { ready: false } });
  }
};
var AreRoute = class _AreRoute extends AreSignal$1 {
  constructor(path) {
    super({
...
var AreEngine = class extends A_Component {
  ...
  static get Execute() {
    return (target, propertyKey, descriptor) => {
      return A_Feature.Extend({
        name: AreEngineFeatures2.Execute,
        scope: [target.constructor],
  ...
  async load(scope) {
    const context = scope?.resolve(AreContext$1) || A_Context.scope(this).resolve(AreContext$1);
    context?.startPerformance();
    await this.call(AreEngineFeatures2.Load, scope || A_Context.scope(this));
  }
  async build(scope) {
    const context = scope?.resolve(AreContext$1) || A_Context.scope(this).resolve(AreContext$1);
    context?.startPerformance("Build Total");
    await this.call(AreEngineFeatures2.Build, scope || A_Context.scope(this));
    context?.endPerformance("Build Total");
  }
  async execute(scope) {
    const context = scope?.resolve(AreContext$1) || A_Context.scope(this).resolve(AreContext$1);
    context?.startPerformance("Execute Total");
    await this.call(AreEngineFeatures2.Execute, scope || A_Context.scope(this));
  ...
  package(scope, dependencies) {
    ...
    const existedContext = scope.resolveConstructor(AreContext$1);
    const existedSyntax = scope.resolveConstructor(AreSyntax$1);
    const existedLoader = scope.resolveConstructor(AreLoader$1);
    const existedTokenizer = scope.resolveConstructor(AreTokenizer$1);
    const existedCompiler = scope.resolveConstructor(AreCompiler$1);
    const existedInterpreter = scope.resolveConstructor(AreInterpreter$1);
    const existedLifecycle = scope.resolveConstructor(AreLifecycle$1);
    const existedTransformer = scope.resolveConstructor(AreTransformer$1);
    const existedSignals = scope.resolveConstructor(AreSignals);
    this.packDependency(scope, context || AreContext$1, existedContext);
    this.packDependency(scope, syntax || AreSyntax$1, existedSyntax);
    this.packDependency(scope, tokenizer || AreTokenizer$1, existedTokenizer);
    this.packDependency(scope, loader || AreLoader$1, existedLoader);
    this.packDependency(scope, compiler || AreCompiler$1, existedCompiler);
    this.packDependency(scope, transformer || AreTransformer$1, existedTransformer);
    this.packDependency(scope, interpreter || AreInterpreter$1, existedInterpreter);
    this.packDependency(scope, lifecycle || AreLifecycle$1, existedLifecycle);
...
__decorateClass([
  ...
  __decorateParam(0, A_Inject(A_Scope)),
  __decorateParam(1, A_Inject(AreSyntax$1)),
  __decorateParam(2, A_Inject(AreSyntax$1)),
  __decorateParam(3, A_Inject(AreTransformer$1)),
  __decorateParam(4, A_Inject(AreLoader$1)),
  __decorateParam(5, A_Inject(AreCompiler$1)),
  __decorateParam(6, A_Inject(AreInterpreter$1)),
  __decorateParam(7, A_Inject(AreLifecycle$1)),
...
export { Are, AreAttribute2 as AreAttribute, AreAttributeFeatures, AreCompiler, AreCompilerError, AreContext, AreDeclaration3 as AreDeclaration, AreEngine, AreEngineError, AreEngineFeatures2 as AreEngineFeatures, AreEvent, AreFeatures, AreInit, AreInstruction3 as AreInstruction, AreInstructionDefaultNames, AreInstructionError, AreInstructionFeatures2 as AreInstructionFeatures, AreInterpreter, AreInterpreterError, AreLifecycle, AreLifecycleError, AreLoader, AreLoaderError, AreMutation2 as AreMutation, AreNode, AreNodeFeatures, AreNodeStatuses, AreRoute, AreScene5 as AreScene, AreSceneError, AreSceneStatuses, AreSignal, AreSignals2 as AreSignals, AreSignalsContext, AreStore2 as AreStore, AreStoreAreComponentMetaKeys, AreSyntax, AreSyntaxError, AreTokenizer, AreTokenizerError, AreTransformer, AreWatcher };
